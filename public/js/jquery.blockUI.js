...
(function () { /*jshint eqeqeq:false curly:false latedef:false */
    ...
    function setup($) {
        ...
        function install(el, opts) {
            ...
            if (opts.theme && full) {
                s = '<div class="blockUI ' + opts.blockMsgClass + ' blockPage ui-dialog ui-widget ui-corner-all" style="z-index:' + (
                    z + 10
                ...
                s = '<div class="blockUI ' + opts.blockMsgClass + ' blockElement ui-dialog ui-widget ui-corner-all" style="z-index:' + (
                    z + 10
            ...
            if (ie6 || expr) { // give body 100% height
