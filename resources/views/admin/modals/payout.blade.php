<div id="payout-modal" class="modal fade hide" tabindex="-1" role="dialog" aria-modal="true" style="padding-right: 17px; display: block;">
                ...
                <div class="text-center">
                    ...
                    <div class="d-flex">
                        ...
                        <form action="" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-danger btn-sm my-2 mr-auto">Accept</button>
                        </form>
                    </div>
                </div>
            </div>
