        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content modal-filled bg-white">
                <div class="modal-body p-4 px-5 position-relative">
                    ...
                    <form action="{{route('coverage_report.store')}}" method="POST" enctype="multipart/form-data" id="coverage-form">
                        @csrf
                        <div class="">
                            ...
                            <small class="w-100 text-info text-right float-right mt-1">Urls are comma(,) seprated.</small>
...
<div id="loader" class="w-100 col-md-12 p-0" >
    ...
    <h4 class="text-center mt-0" style="position: absolute;top: 53%;font-size: 1em;font-weight: 300;padding: 0 111px;"><span style="font-size: 2em;width: 100%;display: inline-block;text-transform: uppercase;text-align: center;font-weight:500">Please wait</span> 
...
<script>
    ...
    $(function(){
        $('#coverage-form').on('submit',function(e){
            ...
            $.ajax({
            url: base_url + "/clients/".concat("{{request()->route()->parameter('id')}}", "/report"),
            type: "POST",
